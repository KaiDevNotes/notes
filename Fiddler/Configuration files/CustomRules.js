...
class Handlers
{
    ...
    */
    ...
    RulesString("&CUSTOM FORWARDING", true)
    RulesStringValue(0,"localhost:8080", "localhost:8080")    
    RulesStringValue(1,"&Custom Address...", "%CUSTOM%")
	
    public static var sForwardHost: String = null;
    ...
    */
    ...
    static function OnBeforeResponse(oSession: Session) {
        ...
        //string replacement
        if (oSession.oRequest.headers.ExistsAndContains("x-calling-product222", "DocketAlertNext-DEMO")){
            FiddlerObject.log("x-calling-product was foung");
            ...
            if(null != oSession.responseBodyBytes){
                ...
                oBody = oBody.replace("casetracking\.int\.legalservices\.demo\.westlaw\.com", "10.143.12.93:8888");
